...
public class DefaultProcessDiagramGenerator {
    ...
    public DefaultProcessDiagramGenerator(final double scaleFactor) {
        ...
        this.activityDrawInstructions.put(StartEvent.class, new com.sx.drainage.config.DefaultProcessDiagramGenerator.ActivityDrawInstruction() {
            public void draw(com.sx.drainage.config.DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
        ...
        this.activityDrawInstructions.put(IntermediateCatchEvent.class, new com.sx.drainage.config.DefaultProcessDiagramGenerator.ActivityDrawInstruction() {
            public void draw(com.sx.drainage.config.DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
        ...
        this.activityDrawInstructions.put(ThrowEvent.class, new com.sx.drainage.config.DefaultProcessDiagramGenerator.ActivityDrawInstruction() {
            public void draw(com.sx.drainage.config.DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
        ...
        this.activityDrawInstructions.put(EndEvent.class, new com.sx.drainage.config.DefaultProcessDiagramGenerator.ActivityDrawInstruction() {
            public void draw(com.sx.drainage.config.DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
        ...
        this.activityDrawInstructions.put(Task.class, new com.sx.drainage.config.DefaultProcessDiagramGenerator.ActivityDrawInstruction() {
            public void draw(com.sx.drainage.config.DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
                processDiagramCanvas.drawTask(flowNode.getName(), graphicInfo);
            }
        });
        this.activityDrawInstructions.put(UserTask.class, new com.sx.drainage.config.DefaultProcessDiagramGenerator.ActivityDrawInstruction() {
            public void draw(com.sx.drainage.config.DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
                processDiagramCanvas.drawUserTask(flowNode.getName(), graphicInfo, scaleFactor);
            }
        });
        this.activityDrawInstructions.put(ScriptTask.class, new com.sx.drainage.config.DefaultProcessDiagramGenerator.ActivityDrawInstruction() {
            public void draw(com.sx.drainage.config.DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
                processDiagramCanvas.drawScriptTask(flowNode.getName(), graphicInfo, scaleFactor);
            }
        });
        this.activityDrawInstructions.put(ServiceTask.class, new com.sx.drainage.config.DefaultProcessDiagramGenerator.ActivityDrawInstruction() {
            public void draw(com.sx.drainage.config.DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
        ...
        this.activityDrawInstructions.put(ReceiveTask.class, new com.sx.drainage.config.DefaultProcessDiagramGenerator.ActivityDrawInstruction() {
            public void draw(com.sx.drainage.config.DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
                processDiagramCanvas.drawReceiveTask(flowNode.getName(), graphicInfo, scaleFactor);
            }
        });
        this.activityDrawInstructions.put(SendTask.class, new com.sx.drainage.config.DefaultProcessDiagramGenerator.ActivityDrawInstruction() {
            public void draw(com.sx.drainage.config.DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
                processDiagramCanvas.drawSendTask(flowNode.getName(), graphicInfo, scaleFactor);
            }
        });
        this.activityDrawInstructions.put(ManualTask.class, new com.sx.drainage.config.DefaultProcessDiagramGenerator.ActivityDrawInstruction() {
            public void draw(com.sx.drainage.config.DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
                processDiagramCanvas.drawManualTask(flowNode.getName(), graphicInfo, scaleFactor);
            }
        });
        this.activityDrawInstructions.put(BusinessRuleTask.class, new com.sx.drainage.config.DefaultProcessDiagramGenerator.ActivityDrawInstruction() {
            public void draw(com.sx.drainage.config.DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
                processDiagramCanvas.drawBusinessRuleTask(flowNode.getName(), graphicInfo, scaleFactor);
            }
        });
        this.activityDrawInstructions.put(ExclusiveGateway.class, new com.sx.drainage.config.DefaultProcessDiagramGenerator.ActivityDrawInstruction() {
            public void draw(com.sx.drainage.config.DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
                processDiagramCanvas.drawExclusiveGateway(graphicInfo, scaleFactor);
            }
        });
        this.activityDrawInstructions.put(InclusiveGateway.class, new com.sx.drainage.config.DefaultProcessDiagramGenerator.ActivityDrawInstruction() {
            public void draw(com.sx.drainage.config.DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
                processDiagramCanvas.drawInclusiveGateway(graphicInfo, scaleFactor);
            }
        });
        this.activityDrawInstructions.put(ParallelGateway.class, new com.sx.drainage.config.DefaultProcessDiagramGenerator.ActivityDrawInstruction() {
            public void draw(com.sx.drainage.config.DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
                processDiagramCanvas.drawParallelGateway(graphicInfo, scaleFactor);
            }
        });
        this.activityDrawInstructions.put(EventGateway.class, new com.sx.drainage.config.DefaultProcessDiagramGenerator.ActivityDrawInstruction() {
            public void draw(com.sx.drainage.config.DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
                processDiagramCanvas.drawEventBasedGateway(graphicInfo, scaleFactor);
            }
        });
        this.activityDrawInstructions.put(BoundaryEvent.class, new com.sx.drainage.config.DefaultProcessDiagramGenerator.ActivityDrawInstruction() {
            public void draw(com.sx.drainage.config.DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
        ...
        this.activityDrawInstructions.put(SubProcess.class, new com.sx.drainage.config.DefaultProcessDiagramGenerator.ActivityDrawInstruction() {
            public void draw(com.sx.drainage.config.DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
        ...
        this.activityDrawInstructions.put(EventSubProcess.class, new com.sx.drainage.config.DefaultProcessDiagramGenerator.ActivityDrawInstruction() {
            public void draw(com.sx.drainage.config.DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
                if(graphicInfo.getExpanded() != null && !graphicInfo.getExpanded().booleanValue()) {
        ...
        this.activityDrawInstructions.put(CallActivity.class, new com.sx.drainage.config.DefaultProcessDiagramGenerator.ActivityDrawInstruction() {
            public void draw(com.sx.drainage.config.DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
                processDiagramCanvas.drawCollapsedCallActivity(flowNode.getName(), graphicInfo);
            }
        });
        this.artifactDrawInstructions.put(TextAnnotation.class, new com.sx.drainage.config.DefaultProcessDiagramGenerator.ArtifactDrawInstruction() {
            public void draw(com.sx.drainage.config.DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, Artifact artifact) {
        ...
        this.artifactDrawInstructions.put(Association.class, new com.sx.drainage.config.DefaultProcessDiagramGenerator.ArtifactDrawInstruction() {
            public void draw(com.sx.drainage.config.DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, Artifact artifact) {
                ...
                graphicInfoList = com.sx.drainage.config.DefaultProcessDiagramGenerator.connectionPerfectionizer(processDiagramCanvas, bpmnModel, (BaseElement)sourceElement, (BaseElement)targetElement, graphicInfoList);
    ...
    protected com.sx.drainage.config.DefaultProcessDiagramCanvas generateProcessDiagram(BpmnModel bpmnModel, String imageType, List<String> highLightedFinishes, List<String> highLightedActivities, List<String> highLightedFlows, String activityFontName, String labelFontName, String annotationFontName, ClassLoader customClassLoader, double scaleFactor) {
        this.prepareBpmnModel(bpmnModel);
        com.sx.drainage.config.DefaultProcessDiagramCanvas processDiagramCanvas = initProcessDiagramCanvas(bpmnModel, imageType, activityFontName, labelFontName, annotationFontName, customClassLoader);
    ...
    protected void drawActivity(com.sx.drainage.config.DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode, List<String> highLightedFinishes, List<String> highLightedActivities, List<String> highLightedFlows, double scaleFactor) {
        com.sx.drainage.config.DefaultProcessDiagramGenerator.ActivityDrawInstruction drawInstruction = this.activityDrawInstructions.get(flowNode.getClass());
        boolean highLighted;
        if(drawInstruction != null) {
            ...
            if(highLightedActivities.contains(flowNode.getId())) {
                drawHighLight(processDiagramCanvas, bpmnModel.getGraphicInfo(flowNode.getId()), com.sx.drainage.config.DefaultProcessDiagramCanvas.HIGHLIGHT_COLOR,flowNode);
            }

            if(highLightedFinishes.contains(flowNode.getId()) && !highLightedActivities.contains(flowNode.getId())) {
                drawHighLight(processDiagramCanvas, bpmnModel.getGraphicInfo(flowNode.getId()), com.sx.drainage.config.DefaultProcessDiagramCanvas.FINISHHIGHLIGHT_COLOR,flowNode);
            }
        }
    ...
    protected static List<GraphicInfo> connectionPerfectionizer(com.sx.drainage.config.DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, BaseElement sourceElement, BaseElement targetElement, List<GraphicInfo> graphicInfoList) {
    ...
    protected void drawArtifact(com.sx.drainage.config.DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, Artifact artifact) {
        com.sx.drainage.config.DefaultProcessDiagramGenerator.ArtifactDrawInstruction drawInstruction = this.artifactDrawInstructions.get(artifact.getClass());
        if(drawInstruction != null) {
    ...
    private static void drawHighLight(com.sx.drainage.config.DefaultProcessDiagramCanvas processDiagramCanvas, GraphicInfo graphicInfo, Color color, FlowNode flowNode) {
    ...
    protected static com.sx.drainage.config.DefaultProcessDiagramCanvas initProcessDiagramCanvas(BpmnModel bpmnModel, String imageType, String activityFontName, String labelFontName, String annotationFontName, ClassLoader customClassLoader) {
        ...
        return new com.sx.drainage.config.DefaultProcessDiagramCanvas((int)maxX + 10, (int)maxY + 10, (int)minX, (int)minY, imageType, activityFontName, labelFontName, annotationFontName, customClassLoader);
    }
    ...
    protected interface ArtifactDrawInstruction {
        void draw(com.sx.drainage.config.DefaultProcessDiagramCanvas var1, BpmnModel var2, Artifact var3);
    }

    protected interface ActivityDrawInstruction {
        void draw(com.sx.drainage.config.DefaultProcessDiagramCanvas var1, BpmnModel var2, FlowNode var3);
    }
}
